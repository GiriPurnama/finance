<?php 
    ...
    { 
      if ($row['status'] == "EksternalHRD" || $row['status'] == "Finance" || $row['status'] == "Master" ) 
      {
        ...
        echo ("<script LANGUAGE='JavaScript'>window.alert('Anda Bukan Tim Finance'); window.location.href='../admin-harda/index.php'</script>");  
      }
    }
    else
    {
